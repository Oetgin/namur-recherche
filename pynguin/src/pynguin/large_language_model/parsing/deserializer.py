...
class StatementDeserializer:  # noqa: PLR0904
    ...
    def _extract_comparison_parts(
        ...
        # Example: assert x == 5
        source = self._get_source_reference(assert_node.test.left)  # type: ignore[attr-defined]
...
class AstToTestCaseTransformer(ast.NodeVisitor):
    ...
    def __init__(self, test_cluster: TestCluster, *, create_assertions: bool):  # noqa: D107
